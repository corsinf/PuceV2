...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      	<div class="row">
      		<div class="col-sm-12">
      			<a href="clase_movimiento.php" class="btn btn-default btn-sm"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
      		</div>
      	</div>
      	<div class="row">
      		<div class="col-sm-6">
      ...
      <div class="modal-footer">
      		<button class="btn btn-primary" onclick="editar_insertar()" type="button" id="btn_editar"><i class="fa fa-save"></i> Guardar</button>
      		<button class="btn btn-danger" onclick="delete_datos()" type="button" id="btn_eliminar"><i class="fa fa-trash"></i> Eliminar</button>
