      ...
      <div class="container-fluid">
          <div class="row">
          	<div class="col-sm-6" id="btn_nuevo">
              	<a href="detalle_familia.php" class="btn btn-success btn-sm"><i class=" fa fa-plus"></i> Nuevo</a>
            ...
            <div class="col-sm-6">
                  <a href="detalle_subfamilia.php" class="btn btn-success btn-sm"><i class=" fa fa-plus"></i> Nuevo</a>              
            </div>
          </div>         
          <div class="row">
          	<div class="col-sm-6">
            ...
            <div class="col-sm-6">              
              <h5>SubFamilias</h5>
              <input type="" name="txt_query1" id="txt_query1" class="form-control form-control-sm" placeholder="Buscar familia" onkeyup="consultar_datos1()">
              <table class="table table-hover table-sm">
                <thead>
                  <th>Codigo</th>
                  <th>Familia</th>
