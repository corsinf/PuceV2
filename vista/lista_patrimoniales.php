...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Patrimoniales</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-3">
            <button class="btn btn-success btn-sm" onclick="location.href = 'patrimoniales.php?fil1=&fil2='"> <i class="fa fa-plus"></i> Agregar Nuevo</button>
          </div>
        </div>
               ...
               <div class="input-group input-group-sm">
                <select class="form-control form-control-sm" id="ddl_custodio" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:80%"></select>
                  <span class="input-group-append">
                    <button type="button" class="btn btn-secondary btn-flat" onclick="limpiar('ddl_custodio')" title="Limpiar custodio"><i class="fa fa-trash"></i></button>
                  </span>
                </div>
             </div>
             ...
             <div class="col-sm-4">
               ...
               <div class="input-group input-group-sm">
                <select class="form-control form-control-sm" id="ddl_localizacion" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:80%"></select>
                  <span class="input-group-append">
                    <button type="button" class="btn btn-secondary btn-flat" onclick="limpiar('ddl_localizacion')" title="Limpiar localizacion"><i class="fa fa-trash"></i></button>
                  </span>
                </div>
             </div>    
            </div>
