...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0 text-dark">Cambiar custodio o localizacion masivamente</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
   		...
   		<div class="row" id="custodio">
             ...
             <b> Antiguo custodio</b>
               <div class="input-group input-group-sm">
                <select class="form-control form-control-sm" id="ddl_custodio" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:100%"><option value="">Seleccione un Custodio</option></select>
                </div>
             ...
             <div class="col-sm-4">
               <b> Nuevo custodio</b>
               <div class="input-group input-group-sm">
                <select class="form-control form-control-sm" id="ddl_custodio2" onchange="$('#txt_pag').val('0-25');lista_articulos()" style="width:100%"><option value="">Seleccione un Custodio</option></select>
                </div>
             </div>
             <div class="col-sm-4">
             	<br>
             	<button class="btn btn-primary btn-sm" onclick="alerta_cambiar()"><i class="fa fa-exchange-alt"></i> Cambiar</button>
             </div>
