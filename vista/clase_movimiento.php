      ...
      <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12" id="btn_nuevo">
              <a href="detalle_clase_movimiento.php?" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>   Nuevo</a>
               <a href="#" class="btn btn-default btn-sm" id="excel_clase_movimientos" title="Informe en excel del total de clase_movimientos"><i class="far fa-file-excel"></i> Total clase_movimientos</a>
            </div>  
          </div>
          <br>
          <div class="row">
            <div class="col-sm-4">
                <input type="" name="" id="txt_buscar" onkeyup="buscar($('#txt_buscar').val())" class="form-control form-control-sm" placeholder="Buscar clase_movimiento"> 
              </div> 
          </div>
