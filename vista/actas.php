...
<script type="text/javascript">
 ...
 function acta5()
 {
  ...
  {
    console.log($('#ddl_localizacion').val());
    ...
    // if($('#ddl_custodio_masivo').val()=='' || $('#ddl_custodio_masivo').val()==null)
    // {
    //   $('#tbl_datos').html('<tr><td colspan="6">Filtre activos</td></tr>');
    //   return false;
    // }
    //  if($('#ddl_localizacion_masivo').val()=='' || $('#ddl_localizacion_masivo').val()==null)
    // {
    //   $('#tbl_datos').html('<tr><td colspan="6">Filtre activos</td></tr>');
    //   return false;
    // }
    ...
    //  if($('#txt_buscar').val()=='' && ($('#ddl_localizacion').val()=='' || $('#ddl_localizacion').val()==null) && $('#ddl_custodio').val()=='' || $('#ddl_custodio').val()==null && $('#ddl_custodio_masivo').val()=='' || $('#ddl_custodio_masivo').val()==null && $('#ddl_localizacion_masivo').val()=='' || $('#ddl_localizacion_masivo').val()==null && $('#txt_query2').val()=='')
    // {
    //   $('#tbl_datos').html('<tr><td colspan="6">Filtre activos</td></tr>');
    //   return false;
    // }
    ...
    $.ajax({
      ...
      dataType: 'json',
        ...
        $.each(response,function(i,item){
          lineas+="<tr><td>"+(i+1)+"</td><td><button class='btn-danger btn-sm btn' onclick='eliminar_lista(\""+item.id+"\")'><i class='fa fa-trash'></i></button></td><td>"+item.asset+"</td><td>"+item.articulo+"</td><td>"+item.valor+"</td></tr>"
          tot+=1;
        });

        $('#lbl_total_a').text(tot)
    ...
    if(query=='' && custodio=='' && location == '')
    {
     ...
     var parametros = 
     {
      ...
      $.ajax({
        ...
        dataType: 'json',
         beforeSend: function () {
         $('#lista_actas').html('<tr><td colspan="6"><img src="../img/de_sistema/loader_puce.gif" width="100" height="100"></td></tr>');          
          },
          success:  function (response) { 
          lista_actas();
         if(response==1)
...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <button type="button" class="btn btn-outline-secondary btn-sm" id="acta1"><i class="fa fa-file"></i> Donaciones Entregadas</button>      
          <button type="button" class="btn btn-outline-secondary btn-sm" id="acta2"><i class="fa fa-file"></i> Custodio Temporal</button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="acta3"><i class="fa fa-file"></i> Custodio Definitivo</button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="acta4"><i class="fa fa-file"></i> Traspaso saliente-entrante</button>
           <button type="button" class="btn btn-outline-secondary btn-sm" id="acta5"><i class="fa fa-file"></i> Donaciones Recibidas</button>    
        </div>
        <hr>
                 <div class="row">
                    <div class="col-sm-5">
                        ...
                        <div class="input-group input-group-sm">
                          ...
                          <button type="button" class="btn btn-outline-secondary btn-sm" onclick="$('#txt_masivo').val(1);$('#txt_buscar').val('');lista_articulos()" title="Pegar codigos de busqueda"><i class="fa fa-times"></i></button>                               
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="input-group input-group-sm">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" onclick="abrir_masivo_custodio()" title="Busqueda masiva por custodi"><i class="fa fa-list" id="icono_cus"></i></button>                              
                   ...
                   <div class="col-sm-4">
                     ...
                     <div class="input-group input-group-sm">
                      <select class="form-control form-control-sm" id="ddl_localizacion" onchange="$('#txt_pag').val('0-25');lista_articulos()">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" onclick="abrir_masivo_localizacion()" title="Busqueda masiva por localizacion"><i class="fa fa-list" id="icono_loc"></i></button>      
             ...
             <div class="col-sm-6">
                <label><input type="checkbox" id="cbx_activo" name="" onclick="lista_articulos()">Activo</label>
        ...
        <div class="row">
          <div class="col-sm-6" style="overflow-x: scroll;height: 400px; overflow-y: scroll;">
            ...
            <table class="table table-striped table-bordered dataTable" style="white-space:nowrap;">
              ...
              <tbody id="tbl_datos">
                <tr><td colspan="8">Filtre los articulos</td></tr>                
              </tbody>
            </table>
            </form>
          </div>
          <div class="col-sm-1">
            ...
            <div class="col">
              <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                <button type="button" class="btn btn-outline-primary" onclick="pasar_selected()">
                  <i class="far fa-check-square"></i><br>
                  <i class="fas fa-arrow-right"></i></button>
                <button type="button" class="btn btn-outline-primary" onclick="pasar_todo()">Todos<br><i class="fas fa-arrow-right"></i></button>
              </div>
            </div>
          </div>           
          <div class="col-sm-5">
             <div class="col text-right">
               <button class="btn btn-danger btn-xs" onclick="eliminar_todo()"><i class="fa fa-trash"></i> Eliminar</button>
            </div>
            <div class="row">
              <div class="col-sm-6">
 ...
 <div class="modal fade" id="modal_actas1" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="modal fade" id="modal_actas5" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade" id="modal_actas2" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="modal fade" id="modal_actas4" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="modal fade" id="modal_tipo_baja" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         ...
         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="$('#txt_query2').val('');$('#txt_masivo').val(0)">Cerrar</button> 
      </div>
    </div>
  </div>
</div>
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12">
          ...
          <div class="row" id="pnl_masivo" style="display: none;">
            ...
            <div class="col-sm-2">
              <button class="btn btn-primary btn-xs" onclick=" validar_codigos_custodios()">Validar</button>
            </div>    
          </div>
        </div>        
          <div class="col-sm-12">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12">
          ...
          <div class="row" id="pnl_masivo_localizacion" style="display: none;">
            ...
            <div class="col-sm-2">
              <button class="btn btn-primary btn-xs" onclick=" validar_codigos_localizacion()">Validar</button>
            </div>    
          </div>
        </div>        
