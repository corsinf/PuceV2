                ...
                '<div class="card-body pt-0">'+
                  '<div class="row">'+
                    ...
                    '<div class="col-5 text-center">'+
                      '<img src="'+foto+'" alt="" class="img-circle img-fluid" style="width: 100%;height: 112px;">'+
                    '</div>'+
                  '</div>'+
                '</div>'+
         ...
         <input type="hidden" id="txt_pag" name="" value="0-25">
          ...
          <div class="row">
            <div class="col-sm-12" id="btn_nuevo">
              <a href="custodio_detalle.php" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>  Nuevo</a>
