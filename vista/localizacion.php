...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Localizacion</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <input type="hidden" id="txt_pag" name="" value="0-25">
          ...
          <div class="row">
            <div class="col-sm-12" id="btn_nuevo">
              <a href="#" class="btn btn-success btn-sm" onclick="location.href='localizacion_detalle.php'"><i class="fa fa-plus"></i>  Nuevo</a>
              <a href="#" class="btn btn-default btn-sm" id="excel_localizacion" title="Informe en excel del total de localizaciones"><i class="far fa-file-excel"></i> Total Localizaciones</a>
            </div>           
          ...
          <div class="row">
            <div class="col-sm-4">
                <input type="" name="" id="txt_buscar" onkeyup="buscar()" class="form-control form-control-sm" placeholder="Buscar Denominacion"> 
              </div>             
          </div>
