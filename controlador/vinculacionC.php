		...
		foreach ($datos as $key => $value) {
			...
			if(!file_exists($value['IMAGEN'])){$value['IMAGEN']='../img/no_disponible.png';}
		 	$tbl.='<tr>		 	
                  ...
                  <td>
                  <div class="btn-group">
                    <button type="button" class="btn btn-danger dropdown-toggle dropdown-icon" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-user-times"></i> Desvincular 
                      ...
                      <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(-1px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
                        <a class="dropdown-item" href="#" onclick="desvincular('.$value['id'].',\'C\')">Por Custodio</a>
                        <a class="dropdown-item" href="#" onclick="desvincular('.$value['id'].',\'L\')">Por Localizacion</a>                        
                      </div>
                    </button>
                  </div>
                  </td>                          
