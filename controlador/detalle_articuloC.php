	...
	function comparacion_movimiento($id,$parametros)
	{
		...
		if($parametros['loca']!=$datos[0]['id_loc'])
		{
			...
			// print_r($movimiento);die();
				$this->cod_globales->ingresar_movimientos($id,$movimiento,$seccion='ARTICULOS',$locAnt[0]['DENOMINACION'],$loc[0]['DENOMINACION'],$locAnt[0]['EMPLAZAMIENTO'],$loc[0]['EMPLAZAMIENTO']);
